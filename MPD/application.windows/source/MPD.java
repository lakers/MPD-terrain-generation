...
public class MPD extends PApplet {
...
public void printmap(float[][] heightmap, int dim) {
  for(int x = 0; x < dim; x++) {
    for(int y = 0; y < dim; y++) {
...
public void MPD(float[][] heightmap, int dim, int pass) {
...
public void initializeCorners(float[][] heightmap, int dim) {
  heightmap[0][0] = 20.0f;
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "MPD" });
  }
}
